...
همان‌طور که در فصل قبل دیدیم، معنای هر برنامه با یک مجموعه‌ی 
...
است. در اشاره به زوج‌های 
$\mathsf{L:B}$
از کلمه‌ی "لیترال" استفاده می‌کنیم.
...
$$\blacktriangleright\blacktriangleright \mathsf{S=\; \{ Sl'' \}}:$$
	در این صورت، توقف پذیری $\mathsf{Sl''}$ را از فرض استقرای، استقرای قبلی( روی لیست دستورات) داریم، پس $\mathsf{\{Sl''\}}$ هم توقف پذیر است.
	
	
در اینجا، اثبات این طرف قضیه به پایان می‌رسد.

($\Leftarrow$)
دوباره باید از استقرا روی ساختار برنامه‌ها استفاده کنیم و دوباره چون هر برنامه‌ای مساوی با یک لیست از دستورات است، ابتدا از استقرا روی ساختار لیست دستورات و در دل آن روی ساختار خود دستورات استفاده کنیم.
