...
نحو زبان بیان برنامه‌ها \gls*{subset}ای از نحو زبان \lr{C} است، به شکل زیر:
...
\begin{defn}
	...
	تعاریف توابعی که در موردشان صحبت کردیم، به این شکل است:
