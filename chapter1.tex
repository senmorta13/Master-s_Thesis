...
\begin{defn}
	هر \gls*{member} \gls*{set}ی $\Phi$ یک \gls*{formula} در زبان \lr{LTL} است و $\Pi$ مجموعه‌ی‌( \gls*{cinf}) \glspl*{atomicformula} است و $\pi \in \Pi$:
	$$
	\Pi \subset \Phi,
	$$
	$$
...
زبان بیان برنامه‌ها \gls*{subset}ای از \glspl*{statement} زبان \lr{C} است، به شکل زیر:
